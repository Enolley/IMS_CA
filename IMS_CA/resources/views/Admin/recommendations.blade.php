                ...
                <div class="title">Requests To Be Recommended</div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a href="#popup1/{{$requests->id}}">Accept</a><a href="#popup2/{{$requests->id}}">Reject</a></td>
                        </tr>
                            ...
                            <div class="popup">
                                ...
                                <div class="content">
                                    <form action="{{route('approve')}}" method="post">
                                        ...
                                        <input type="text" name="assigned_to" id="" placeholder="Assign to">
                        ...
                        <div id="popup2/{{$requests->id}}" class="overlay">
                            <div class="popup">
                                <h2>Remarks</h2>
                                <a class="close" href="#">&times;</a>
                                <div class="content">
